      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[1.5rem] border border-border bg-surface-strong p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-muted">
              Current topics cover functions, async JavaScript, browser internals, and performance-related behavior. The goal is depth over noise, so this page stays structured and minimal.
            </p>
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.2rem] bg-background/70 p-4">
                <p className="text-sm font-semibold text-foreground">Async topics</p>
                <p className="mt-2 text-sm leading-7 text-muted">
                  Promises, async/await, event loop behavior, and execution order.
                </p>
              </div>
              <div className="rounded-[1.2rem] bg-background/70 p-4">
                <p className="text-sm font-semibold text-foreground">Function topics</p>
                <p className="mt-2 text-sm leading-7 text-muted">
                  Closures, hoisting, `this`, and debounce behavior in practice.
                </p>
              </div>
            </div>
          </div>
